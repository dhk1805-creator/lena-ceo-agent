...
// 3 tầng user: VIP (Sonnet 3.5) | STAFF (Haiku) | Follower (Haiku+KB)
// CBCNV hardcoded · Zalo ID lưu file · KB nhúng trực tiếp
// ============================================================
...
const MODEL_VIP          = 'claude-sonnet-4-5';          // VIP — Sonnet 3.5
const MODEL_STAFF        = 'claude-haiku-4-5-20251001';  // CBCNV nội bộ
const MODEL_FOLLOWER     = 'claude-haiku-4-5-20251001';  // Follower/khách

// ============================================================
// === DANH SÁCH 44 CBCNV NSCA — HARDCODED
// ============================================================
const NSCA_STAFF = [
  // Ban Giám Đốc
  { id:'CEO01', name:'Đào Huy Khánh',          nick:'Sếp Khánh',    pos:'CEO — Tổng Giám đốc',          dept:'Ban GĐ', email:'dhk@nsca.vn',       phone:'0903232222', notes:'VIP' },
  { id:'BGD02', name:'Nguyễn Thị Thúy Hồng',  nick:'Chị Hồng',     pos:'GĐ Đại diện Pháp luật',        dept:'Ban GĐ', email:'nsca@nsca.vn',      phone:'0903220024', notes:'VIP' },
  { id:'BGD03', name:'Nguyễn Thị Thanh Mai',   nick:'Chị Mai',      pos:'Trợ lý CEO · Quản lý Users',   dept:'Ban GĐ', email:'maintt@nsca.vn',    phone:'0916888001', notes:'' },
  // PKD
  { id:'PKD01', name:'Đào Nguyên Ngọc',        nick:'Anh Ngọc',     pos:'TP PKD',                        dept:'PKD',    email:'ndao@nsca.vn',      phone:'0902115796', notes:'VIP — Bộc Béo' },
  { id:'PKD02', name:'Đỗ Đình Đức',            nick:'Anh Đức BD',   pos:'BD Nội địa',                    dept:'PKD',    email:'ducdd@nsca.vn',     phone:'0912345678', notes:'' },
  { id:'PKD03', name:'Santiago De Los Reyes',  nick:'Santi',        pos:'Xuất khẩu',                     dept:'PKD',    email:'santiago@nsca.vn',  phone:'0978123456', notes:'' },
  { id:'PKD04', name:'Nguyễn Thị Thanh Tâm',  nick:'Chị Tâm',      pos:'Back Office',                   dept:'PKD',    email:'tamntt@nsca.vn',    phone:'0934567890', notes:'' },
  { id:'PKD05', name:'PKD-Admin',              nick:'Admin PKD',    pos:'Admin',                         dept:'PKD',    email:'pkd05@nsca.vn',     phone:'0945678901', notes:'' },
  { id:'PKD06', name:'PKD-Công nợ',            nick:'Công nợ PKD',  pos:'Công nợ',                       dept:'PKD',    email:'pkd06@nsca.vn',     phone:'0956789012', notes:'' },
  { id:'PKD07', name:'BO1',                    nick:'BO1',          pos:'Back Office 1',                 dept:'PKD',    email:'pkd07@nsca.vn',     phone:'0967890123', notes:'' },
  { id:'PKD08', name:'BO2',                    nick:'BO2',          pos:'Back Office 2',                 dept:'PKD',    email:'pkd08@nsca.vn',     phone:'0978901234', notes:'' },
  { id:'PKD09', name:'BO3',                    nick:'BO3',          pos:'Back Office 3',                 dept:'PKD',    email:'pkd09@nsca.vn',     phone:'0989012345', notes:'' },
  { id:'PKD10', name:'BO4',                    nick:'BO4',          pos:'Back Office 4',                 dept:'PKD',    email:'pkd10@nsca.vn',     phone:'0990123456', notes:'' },
  // QLSX
  { id:'SX01',  name:'Nguyễn Văn Ngọc',        nick:'Anh Ngọc SX',  pos:'GĐ NM + TP SX Nhôm',           dept:'QLSX',   email:'ngocnv@nsca.vn',    phone:'0913204330', notes:'' },
  { id:'SX02',  name:'Hoàng Mạnh Tùng',        nick:'Anh Tùng',     pos:'PGĐ SX Thép',                  dept:'QLSX',   email:'tunghm@nsca.vn',    phone:'0924315441', notes:'' },
  { id:'SX03',  name:'Đinh Văn Phong',          nick:'Anh Phong',    pos:'PGĐ Cơ Điện',                  dept:'QLSX',   email:'phongdv@nsca.vn',   phone:'0935426552', notes:'' },
  { id:'SX04',  name:'Nguyễn Lương Tuấn',      nick:'Anh Tuấn QC',  pos:'TB QA/QC',                     dept:'QLSX',   email:'tuannl@nsca.vn',    phone:'0946537663', notes:'' },
  { id:'SX05',  name:'Vũ Trọng Đức',           nick:'Anh Đức GH',   pos:'TB Giao Hàng',                  dept:'QLSX',   email:'ducvt@nsca.vn',     phone:'0957648774', notes:'' },
  { id:'SX06',  name:'Nguyễn Thị Hà',          nick:'Chị Hà',       pos:'TB Kho',                        dept:'QLSX',   email:'hant@nsca.vn',      phone:'0968759885', notes:'' },
  { id:'SX07',  name:'Đặng Thị Kim Anh',       nick:'Chị Kim Anh',  pos:'TB Cung Ứng',                   dept:'QLSX',   email:'anhdtk@nsca.vn',    phone:'0979860996', notes:'' },
  { id:'SX08',  name:'Nguyễn Thị Xuân',        nick:'Chị Xuân',     pos:'KHSX Nhôm',                     dept:'QLSX',   email:'xuannt@nsca.vn',    phone:'0980971007', notes:'' },
  { id:'SX09',  name:'Đinh Tiến Long',          nick:'Anh Long',     pos:'Trợ lý Nhà máy',               dept:'QLSX',   email:'longdt@nsca.vn',    phone:'0991082118', notes:'' },
  { id:'SX10',  name:'Nguyễn Thị Hoa',         nick:'Chị Hoa',      pos:'KHSX Thép',                     dept:'QLSX',   email:'hoant@nsca.vn',     phone:'0902193229', notes:'' },
  { id:'SX11',  name:'Trần Thị Lan Hương',     nick:'Chị Hương',    pos:'NV Cung ứng',                   dept:'QLSX',   email:'huongttl@nsca.vn',  phone:'0913304330', notes:'' },
  { id:'SX12',  name:'Nguyễn Hùng Cường',      nick:'Anh Cường CD', pos:'NV Cơ điện',                    dept:'QLSX',   email:'cuongnh@nsca.vn',   phone:'0924415441', notes:'' },
  { id:'SX13',  name:'Trịnh Văn Dũng',         nick:'Anh Dũng',     pos:'NV Cơ điện',                    dept:'QLSX',   email:'dungtv@nsca.vn',    phone:'0935526552', notes:'' },
  { id:'SX14',  name:'Đoàn Thị Tính',          nick:'Chị Tính',     pos:'NV Kho',                        dept:'QLSX',   email:'tinhdt@nsca.vn',    phone:'0946637663', notes:'' },
  { id:'SX15',  name:'Đỗ Thị Thu Thùy',        nick:'Chị Thùy',     pos:'NV Giao hàng',                  dept:'QLSX',   email:'thuydtt@nsca.vn',   phone:'0957748774', notes:'' },
  { id:'SX16',  name:'Cấn Ngọc Duy',           nick:'Anh Duy',      pos:'NV Giao hàng',                  dept:'QLSX',   email:'duycn@nsca.vn',     phone:'0968859885', notes:'' },
  { id:'SX17',  name:'Đỗ Thị Ngọc',            nick:'Chị Ngọc Kho', pos:'NV Kho',                        dept:'QLSX',   email:'ngocdt@nsca.vn',    phone:'0979960996', notes:'' },
  { id:'SX18',  name:'Vũ Văn Cường',           nick:'Anh Cường Kho',pos:'NV Kho',                        dept:'QLSX',   email:'cuongvv@nsca.vn',   phone:'0981071007', notes:'' },
  // TCKT
  { id:'TC01',  name:'Nguyễn Tiến Duẩn',       nick:'Anh Duẩn',     pos:'Trưởng ban TCKT',               dept:'TCKT',   email:'duannt@nsca.vn',    phone:'0912876543', notes:'Duẩn chạy nhanh' },
  { id:'TC02',  name:'Nguyễn Thị Hương Giang', nick:'Chị Giang',    pos:'Phó ban TCKT',                  dept:'TCKT',   email:'giangnth@nsca.vn',  phone:'0923987654', notes:'' },
  { id:'TC03',  name:'Trần Thị Hằng',          nick:'Chị Hằng Thuế',pos:'KT Thuế',                       dept:'TCKT',   email:'hangtt@nsca.vn',    phone:'0934098765', notes:'' },
  { id:'TC04',  name:'Đỗ Thị Thuỷ Hằng',      nick:'Chị Hằng KT',  pos:'KT Sản xuất',                   dept:'TCKT',   email:'hangdtt@nsca.vn',   phone:'0945109876', notes:'' },
  { id:'TC05',  name:'Nguyễn Văn Duật',        nick:'Anh Duật',     pos:'KT Bán hàng',                   dept:'TCKT',   email:'duatnv@nsca.vn',    phone:'0956210987', notes:'' },
  // R&D
  { id:'RD01',  name:'Phạm Hoài Nam',          nick:'Anh Nam',      pos:'TP R&D',                        dept:'R&D',    email:'namph@nsca.vn',     phone:'0967321098', notes:'' },
  { id:'RD02',  name:'Abhishek Dewangan',      nick:'Abi',          pos:'KS Tính toán/Mô phỏng',         dept:'R&D',    email:'dewangana@nsca.vn', phone:'0978432109', notes:'' },
  { id:'RD03',  name:'Nguyễn Lương Tuấn',      nick:'Anh Tuấn R&D', pos:'KS Chuẩn hóa SX',              dept:'R&D',    email:'tuannl@nsca.vn',    phone:'0989543210', notes:'' },
  { id:'RD04',  name:'Trần Quang Huy',         nick:'Anh Huy',      pos:'KS Cơ điện tử',                 dept:'R&D',    email:'huytq@nsca.vn',     phone:'0990654321', notes:'' },
  // HCNS
  { id:'HC01',  name:'Đặng Văn Sơn',           nick:'Anh Sơn',      pos:'TP HCNS',                       dept:'HCNS',   email:'sondv@nsca.vn',     phone:'0901765432', notes:'' },
  { id:'HC03',  name:'HCNS 02',                nick:'HCNS 02',      pos:'Lương & Chấm công',              dept:'HCNS',   email:'hc03@nsca.vn',      phone:'0923987602', notes:'' },
  { id:'HC04',  name:'HCNS 03',                nick:'HCNS 03',      pos:'Tuyển dụng & Đào tạo',           dept:'HCNS',   email:'hc04@nsca.vn',      phone:'0934098703', notes:'' },
];

// Build email→staff lookup map
const STAFF_BY_EMAIL = {};
NSCA_STAFF.forEach(s => { STAFF_BY_EMAIL[s.email.toLowerCase()] = s; });

// ============================================================
// === ZALO ID FILE — lưu mapping zaloId↔email nội bộ
// === /root/.openclaw/staff-zalo-ids.json
...
function loadZaloIdMap() {
  try {
    if (fs.existsSync(ZALO_ID_FILE)) return JSON.parse(fs.readFileSync(ZALO_ID_FILE, 'utf-8'));
  } catch (e) {}
  return {};
}
...
function lookupStaffByZaloId(zaloId) {
  ...
  return STAFF_BY_EMAIL[email.toLowerCase()] || null;
}
...
function lookupStaffByNameInput(input) {
  const q = input.toLowerCase().trim();
  // Match by email first
  if (q.includes('@')) {
    const s = STAFF_BY_EMAIL[q];
    if (s) return s;
  }
  ...
  return NSCA_STAFF.find(s =>
    ...
    s.email.toLowerCase().startsWith(q.split('@')[0])
  ) || null;
}
...
function getOAToken() {
  try {
    if (fs.existsSync(TOKEN_FILE)) { const d = JSON.parse(fs.readFileSync(TOKEN_FILE,'utf-8')); if (d.access_token) return d.access_token; }
  } catch(e) {}
  return process.env.ZALO_OA_ACCESS_TOKEN;
}
function getRefreshToken() {
  try {
    if (fs.existsSync(TOKEN_FILE)) { const d = JSON.parse(fs.readFileSync(TOKEN_FILE,'utf-8')); if (d.refresh_token) return d.refresh_token; }
  } catch(e) {}
...
function loadSession(key) {
  const f=path.join(SESSION_DIR,`${key}.json`);
...
function getSessionAgeMin(key) {
  const f=path.join(SESSION_DIR,`${key}.json`);
  try { if (fs.existsSync(f)) return Math.floor((Date.now()-fs.statSync(f).mtime.getTime())/60000); } catch(e) {}
  return Infinity;
}

// ============================================================
// === FOLLOWER PERSISTENT MEMORY (Google Sheet)
// ============================================================
...
async function loadFollowerProfile(userId) {
  try {
    ...
    for (const line of stdout.trim().split('\n').filter(Boolean)) {
      try { const r=JSON.parse(line); if (Array.isArray(r)&&r[0]===userId) return {userId:r[0],name:r[1]||null,firstSeen:r[2],lastSeen:r[3],language:r[4]||'vi',topics:r[5]||'',lastMessage:r[6]||'',notes:r[7]||''}; } catch(e) {}
    }
...
// ============================================================
// === HVAC KNOWLEDGE BASE (KB-1.0 · 2026-05-13)
// ============================================================
const LENA_KB = `
...
- If not found → keep original English, never guess
- Cite standard when referencing specs
...
### KEY FORMULAS
| Formula | VI | Equation | Unit |
|---|---|---|---|
| Dry Air Mass Flow | Lưu lượng khối khí khô | m_da=Q2/[1.005×(T1-T3)] | kg/s |
...
| Density | Mật độ khí ẩm | ρ=1/v | kg/m³ |
...
| Air Flow Rate | Lưu lượng KK | CFM=Q/[1.23×ΔT] | CFM |
| Cooling Load | Tải lạnh | TR=Q/12000 | TR |
...
| Fan Flow | Tỉ lệ lưu lượng quạt | Q1/Q2=N1/N2 | — |
| Fan Pressure | Tỉ lệ áp suất quạt | P1/P2=(N1/N2)² | — |
| Fan Power | Tỉ lệ công suất quạt | HP1/HP2=(N1/N2)³ | — |

### UNIT CONVERSIONS
1 TR=3.517 kW=12,000 Btu/hr | 1 CFM=0.4719 L/s | 1 kW=3412 Btu/hr | 1 in.wg=249.1 Pa | °F=9/5×°C+32

### MULTILINGUAL GLOSSARY (EN | VI | ZH | KO | JP)
...
Volume Control Damper | Van điều chỉnh lưu lượng | 风量调节阀 | VCD댐퍼 | 風量調節ダンパー [AMCA 500-D]
Fire Damper | Van ngăn cháy | 防火阀 | 방화댐퍼 | 防火ダンパー [UL 555]
Smoke Damper | Van ngăn khói | 防烟阀 | 연기댐퍼 | 防煙ダンパー [UL 555S]
Combination Fire/Smoke | Van ngăn cháy-khói | 防火防烟阀 | 복합댐퍼 | 防火防煙ダンパー [UL 555/555S]
...
ADPI | Chỉ số hiệu suất khuếch tán | 空气扩散性能指数 | 공기확산성능지수 | 気流拡散性能指数 [ASHRAE 70]
Throw | Tầm phun | 射程 | 취출거리 | 到達距離 [ASHRAE 70]
Coanda Effect | Hiệu ứng Coanda | 柯恩达效应 | 코안다효과 | コアンダ効果
PMV | Chỉ số cảm giác nhiệt | 预测平均热感觉 | PMV | 予測平均申告 [ASHRAE 55/ISO 7730]
PPD | Tỉ lệ không thỏa mãn | 预测不满意率 | PPD | 予測不満足率 [ASHRAE 55]
IAQ | Chất lượng KK trong nhà | 室内空气质量 | 실내공기질 | 室内空気質 [ASHRAE 62.1]
CO₂ | Nồng độ CO₂ | 二氧化碳浓度 | 이산화탄소농도 | 二酸化炭素濃度 [ASHRAE 62.1]
HEPA Filter | Bộ lọc HEPA | 高效空气过滤器 | 헤파필터 | HEPAフィルター [EN 1822]
MERV | Cấp lọc MERV | MERV过滤等级 | MERV등급 | MERV評価 [ASHRAE 52.2]
...
VRF | Hệ thống lưu lượng môi chất biến đổi | 变冷媒流量 | VRF | 可変冷媒流量 [AHRI 1230]
Heat Pump | Bơm nhiệt | 热泵 | 히트펌프 | ヒートポンプ
ERV | Thiết bị thu hồi năng lượng | 能量回收新风机 | 에너지회수환기 | 全熱交換型換気 [AHRI 1060]
VFD/VSD | Biến tần | 变频器 | 인버터 | インバーター [IEC 61800]
BAS | Hệ thống tự động hóa tòa nhà | 楼宇自控 | 빌딩자동화 | ビル自動化 [ISO 16484]
BACnet | Giao thức BACnet | BACnet协议 | BACnet프로토콜 | BACnetプロトコル [ASHRAE 135]
Commissioning | Nghiệm thu vận hành | 调试验收 | 시운전 | コミッショニング [ASHRAE Guideline 0]
TAB | Kiểm tra điều chỉnh cân bằng | 测试调整平衡 | 시험조정밸런싱 | 試験調整バランシング [ASHRAE GL.12]
Fire Rating | Cấp chịu lửa | 耐火等级 | 내화등급 | 耐火等級 [UL 555/NFPA 90A]
Fusible Link | Mắt cầu chì nhiệt | 易熔合金片 | 용융링크 | 温度ヒューズ [UL 33]
Smoke Control | Hệ thống kiểm soát khói | 防排烟系统 | 연기제어 | 防煙システム [NFPA 92]
Stairwell Pressurization | Tăng áp thang bộ | 楼梯间加压 | 계단실가압 | 階段加圧 [NFPA 92]
NC | Tiêu chí ồn | 噪声评价 | 소음기준 | NC曲線 [ASHRAE HVAC Apps]
...
- Certifications: UL 555 (fire damper), UL 555S (smoke damper), FM, AHRI 880, AMCA member
- Products: grilles, diffusers, VAV boxes (SVAV-S), fire/smoke/volume dampers, louvers, silencers
- Models do NOT translate: SAG, DAG, SKD, SLD-A2S, SVAV-S, VCD, S-MFSD
- Technical contact: info@nsca.vn | Sales: sales@nsca.vn | Hotline: 0246.260.9999
- Website: starduct.vn | Manufacturer: NSCA, Dan Phuong, Hanoi, Vietnam

### STARDUCT PRODUCT TERMS (VI ↔ EN)
...
Hộp VAV = VAV Box SVAV-S [AHRI 880]
Bộ giảm âm = Silencer/Attenuator [AMCA 300]
Lá chớp = Louver [AMCA 500-L]
Bộ truyền động lò xo = Spring-return actuator [Belimo/Honeywell]
...
const STAFF_TOOLS = [
  {name:'web_search',description:'Tìm kiếm thông tin kỹ thuật, tiêu chuẩn.',input_schema:{type:'object',properties:{query:{type:'string'},max_results:{type:'number'}},required:['query']}},
  {name:'web_read',description:'Đọc trang web.',input_schema:{type:'object',properties:{url:{type:'string'}},required:['url']}},
...
const FOLLOWER_TOOLS = [
  {name:'web_search',description:'Search web for current HVAC standards, news.',input_schema:{type:'object',properties:{query:{type:'string'},max_results:{type:'number'}},required:['query']}},
...
async function runAgentLoop(model, systemPrompt, tools, session, maxIter=8) {
  ...
  while(iters++<maxIter) {
    const res=await fetch('https://api.anthropic.com/v1/messages',{
      ...
      body:JSON.stringify({model,max_tokens:tools===VIP_TOOLS?2000:500,system:systemPrompt,tools,messages:session})
    });
...
// ============================================================
// === STAFF PENDING REGISTRATION (in-memory)
// ============================================================
// Map: zaloId → { askedAt, attempts }
const _staffPending = new Map();
...
async function handleUserMessage(event) {
  ...
  // 4. Có thể là CBCNV chưa đăng ký? (nhắn email nội bộ)
  if(/@nsca\.vn/i.test(messageText)){
    await handleStaffRegistration(senderId,messageText); return;
  }
...
// ============================================================
// === VIP HANDLER — Sonnet 3.5 + full tools
// ============================================================
...
${isFresh?`Session MỚI — có thể mở đầu ngắn "Dạ ${vip.name}..." 1 lần.`:`Session ACTIVE (${sessionAgeMin}p trước) — KHÔNG chào, trả lời THẲNG.`}

NGUYÊN TẮC: Xưng "em" | Ngắn gọn có số liệu | KHÔNG ký tên | Max 500 ký tự/tin
LUẬT 1 — KHÔNG HỎI: VIP ra lệnh → GỌI TOOL NGAY. KHÔNG đưa options.
LINK: web_search verify TRƯỚC khi gửi link.
CODE/CRON: Sếp nói "sửa/thêm/fix" → github_create_issue NGAY.
SHEET: ID đã có sẵn — chỉ cần range. 3 VIP ĐỘC LẬP.`;

  let reply='';
  try {
    reply=await runAgentLoop(MODEL_VIP,systemPrompt,VIP_TOOLS,session,15);
  } catch(e) {
...
async function handleStaffMessage(senderId, messageText, staff) {
  ...
  const sessionAgeMin=getSessionAgeMin(sessionKey);
  let session=loadSession(sessionKey);
  if(!Array.isArray(session)) session=[];
  session.push({role:'user',content:messageText});
  if(session.length>20) session.splice(0,session.length-20);
  const isFresh=session.length<=1||sessionAgeMin>=360;

  const today=new Date().toLocaleString('vi-VN',{timeZone:'Asia/Ho_Chi_Minh'});
  const systemPrompt=`Bạn là Lê Na — trợ lý AI nội bộ NSCA/STARDUCT.

ĐANG CHAT VỚI: ${nick} (${staff.name})
Chức vụ: ${staff.pos} | Bộ phận: ${staff.dept} | Email: ${staff.email}
Mã NV: ${staff.id} | Thời gian: ${today}
${staff.notes?`Ghi chú: ${staff.notes}`:''}

${isFresh?`Session mới — chào ngắn "Dạ ${nick}! Em nghe ạ." rồi vào nội dung.`:`Session active (${sessionAgeMin}p) — KHÔNG chào lại, trả lời thẳng.`}

GIAO TIẾP: Xưng "em", gọi đúng "${nick}" | Thân thiện nội bộ | Ngắn gọn thực tế

QUYỀN HẠN:
✅ Hỏi task ĐƯỢC GIAO CHO CHÍNH HỌ (${staff.email})
✅ Hỏi lịch họp bộ phận ${staff.dept}
✅ Hỏi kỹ thuật HVAC/sản phẩm STARDUCT
✅ Tra cứu quy trình nội bộ
✅ Báo hoàn thành task → Lê Na ghi nhận và thông báo trưởng bộ phận nếu cần
❌ KHÔNG xem task/KPI/email của người khác
❌ KHÔNG xem dữ liệu lương, tài chính

KHI HỌ BÁO HOÀN THÀNH TASK:
→ "Em đã note lại. ${nick} muốn em báo cho [trưởng BP] không?"

${LENA_KB}`;

  let reply='';
  try { reply=await runAgentLoop(MODEL_STAFF,systemPrompt,STAFF_TOOLS,session,5); }
  catch(e) {
    console.error(`[STAFF] ${e.message}`);
    reply=`Dạ ${nick}, em đang gặp sự cố kỹ thuật. Thử lại sau ít phút nhé.`;
  }
...
// ============================================================
// === STAFF REGISTRATION — tự động hỏi tên, lưu Zalo ID
// ============================================================
async function handleStaffRegistration(senderId, messageText) {
  const pending=_staffPending.get(senderId);

  if(pending) {
    // Đang chờ user nhập tên/email
    const matched=lookupStaffByNameInput(messageText);
    if(matched) {
      registerStaffZaloId(senderId,matched.email);
      _staffPending.delete(senderId);
      await sendZaloMessage(senderId,
        `✅ Đã xác nhận!\n${matched.nick} — ${matched.pos} — Bộ phận ${matched.dept}\n\nTừ giờ ${matched.nick} có thể hỏi em về task, lịch họp, sản phẩm STARDUCT hoặc bất cứ gì cần hỗ trợ ạ!`
      );
      // Xử lý tin nhắn gốc nếu không phải chỉ là tên
    ...
    if(attempts>=3) {
      _staffPending.delete(senderId);
      await sendZaloMessage(senderId,'Em chưa tìm thấy trong danh sách NSCA. Anh/chị liên hệ bộ phận HCNS (Anh Sơn — sondv@nsca.vn) để được thêm vào hệ thống nhé.');
      return;
    }
  ...
  // Lần đầu — kiểm tra email trong tin nhắn
  if(/@nsca\.vn/i.test(messageText)) {
    const emailMatch=messageText.match(/[\w.]+@nsca\.vn/i);
    if(emailMatch) {
      const matched=lookupStaffByNameInput(emailMatch[0]);
      if(matched) {
        registerStaffZaloId(senderId,matched.email);
        await sendZaloMessage(senderId,`✅ Xác nhận! Em nhận diện: ${matched.nick} — ${matched.pos} — ${matched.dept}.\nTừ giờ anh/chị có thể hỏi em về task, lịch họp, và kỹ thuật STARDUCT ạ!`);
        return;
      }
    }
  }
  ...
  await sendZaloMessage(senderId,
    'Chào anh/chị! Em là Lê Na — trợ lý AI nội bộ của NSCA/STARDUCT.\n\nEm thấy anh/chị chưa đăng ký với hệ thống. Anh/chị cho em biết tên hoặc email nội bộ để em nhận diện nhé ạ?\n(Ví dụ: "Phạm Hoài Nam" hoặc "namph@nsca.vn")'
  );
}

// ============================================================
// === FOLLOWER HANDLER — Haiku + KB + web_search + memory
// ============================================================
async function handleFollowerMessage(senderId, messageText) {
  ...
  const memCtx=isFirst
    ...
    :`USER MEMORY:\n- Name: ${knownName}\n- First contact: ${profile.firstSeen?new Date(profile.firstSeen).toLocaleDateString('vi-VN'):'unknown'}\n- Last seen: ${lastSeen||'unknown'}\n- Previous topics: ${lastTopics||'none'}\n- Reference past topics when relevant. Address by name.`;

  const systemPrompt=`You are Lê Na — official AI assistant of STARDUCT (NSCA, Dan Phuong, Hanoi, Vietnam). Website: starduct.vn

${memCtx}

LANGUAGE RULE (CRITICAL): Detect language from user message. ALWAYS reply in SAME language.
Vietnamese → reply Vietnamese (xưng "em", gọi "anh/chị" hoặc tên)
English → reply English

TOOLS: Use web_search when you need current/updated info not in KB. Use memory_search for past STARDUCT facts.
Simple HVAC calc or terminology in KB below → answer DIRECTLY, no tool needed.

STYLE: Friendly, professional, concise (max 3-4 sentences unless calculation needed).
Pricing/ordering → "Liên hệ sales@nsca.vn hoặc 0246.260.9999 ạ."
Complex technical → "Gửi yêu cầu về info@nsca.vn, team R&D hỗ trợ trong 24h ạ."
NEVER invent specs, model codes, pricing, or standards.

${LENA_KB}`;

  let reply='';
  try { reply=await runAgentLoop(MODEL_FOLLOWER,systemPrompt,FOLLOWER_TOOLS,session,5); }
  catch(e) {
    console.error(`[FOLLOWER] ${e.message}`);
    reply='Xin lỗi anh/chị, em đang gặp sự cố. Vui lòng liên hệ info@nsca.vn ạ.\nSorry, please contact info@nsca.vn.';
  }
...
app.get('/health',(req,res)=>res.json({
  ...
  model_vip:MODEL_VIP, model_staff:MODEL_STAFF, model_follower:MODEL_FOLLOWER,
  vips:Object.keys(VIP_USERS).filter(k=>!k.startsWith('_none_')).length,
  staff_count:NSCA_STAFF.length,
  registered_staff:Object.keys(loadZaloIdMap()).length,
...
app.get('/staff-list',(req,res)=>{
  ...
  res.json({
    ...
    registered:NSCA_STAFF.filter(s=>map[Object.keys(map).find(k=>map[k]===s.email)||'']).length,
    staff:NSCA_STAFF.map(s=>({id:s.id,nick:s.nick,dept:s.dept,email:s.email,registered:Object.values(map).includes(s.email)}))
  });
});
...
app.get('/debug',async(req,res)=>{
  ...
  res.json({vips:vipList,claude_api:claudeOk?'OK':'FAIL',model_vip:MODEL_VIP,model_staff:MODEL_STAFF,model_follower:MODEL_FOLLOWER,staff:NSCA_STAFF.length,registered:Object.keys(loadZaloIdMap()).length,kb_chars:LENA_KB.length,zalo_token:getOAToken()?'OK':'MISSING'});
});
...
const server=app.listen(FRONT_PORT,'0.0.0.0',()=>{
  ...
  console.log(`[proxy] CBCNV: ${NSCA_STAFF.length} hardcoded | Registered: ${Object.keys(loadZaloIdMap()).length}`);
  console.log(`[proxy] KB: ${LENA_KB.length} chars embedded`);
