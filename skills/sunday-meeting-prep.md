...
Dung EXEC gui cho Sep Khanh: `node /app/google-tools/zalo-oa-send.js sep-khanh "noi dung tom tat"`
Dung EXEC gui cho chi Hong: `node /app/google-tools/zalo-oa-send.js chi-hong "noi dung tom tat"`
