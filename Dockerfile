...
RUN apt-get update && apt-get install -y git curl ca-certificates fonts-noto-core fonts-noto-cjk fontconfig antiword catdoc && rm -rf /var/lib/apt/lists/* && fc-cache -fv
